...
while True:
    if sum == 0 :
        orig_image = cv2.imread('/home/abhay_kashyap03/Pictures/img4.jpg')
    else:
    ...
    sum += boxes.shape[0]
    if sum == 0 :
        cv2.imwrite("results/img_test"+str(sum)+".jpg", orig_image)
    if sum % 10 == 0 :
        cv2.imwrite("results/cam_results/img"+str(sum)+".jpg", orig_image)
