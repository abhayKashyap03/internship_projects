...
parser.add_argument('-c', '--checkpoint', default='mobilenet_224_model_best_gdconv_external.pth.tar', type=str, metavar='PATH',
                    help='path to save checkpoint (default: checkpoint)')
parser.add_argument('--type', choices=['folder', 'img'], default='img')
